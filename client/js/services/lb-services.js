 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/books/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Book.notes.findById() instead.
            "prototype$__findById__notes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/books/:id/notes/:fk",
              method: "GET",
            },

            // INTERNAL. Use Book.notes.destroyById() instead.
            ...
            // INTERNAL. Use Book.notes.updateById() instead.
            ...
            // INTERNAL. Use Book.notes() instead.
            "prototype$__get__notes": {
              isArray: true,
              url: urlBase + "/books/:id/notes",
              method: "GET",
            },

            // INTERNAL. Use Book.notes.create() instead.
            "prototype$__create__notes": {
              url: urlBase + "/books/:id/notes",
              method: "POST",
            },

            // INTERNAL. Use Book.notes.destroyAll() instead.
            "prototype$__delete__notes": {
              url: urlBase + "/books/:id/notes",
              method: "DELETE",
            },

            // INTERNAL. Use Book.notes.count() instead.
            "prototype$__count__notes": {
              url: urlBase + "/books/:id/notes/count",
              method: "GET",
            },
            ...
            // INTERNAL. Use Note.book() instead.
            "::get::Note::book": {
              url: urlBase + "/notes/:id/book",
              method: "GET",
            },
          }
        );
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Book#patchAttributes
             * @methodOf lbServices.Book
             *
             * @description
             *
    ...
    /**
     * @ngdoc object
     * @name lbServices.Book.notes
     * @header lbServices.Book.notes
     * @object
     * @description
     *
     * The object `Book.notes` groups methods
     * manipulating `Note` instances related to `Book`.
     *
     * Call {@link lbServices.Book#notes Book.notes()}
     ...
     */
        ...
        R.notes = function() {
          ...
          var action = TargetResource["::get::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#count
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
             * Counts notes of book.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - book id
        ...
        R.notes.count = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::count::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#create
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
        ...
        R.notes.create = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::create::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#createMany
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
        ...
        R.notes.createMany = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::createMany::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#destroyAll
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
        ...
        R.notes.destroyAll = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::delete::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#destroyById
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
        ...
        R.notes.destroyById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::destroyById::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#findById
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
        ...
        R.notes.findById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::findById::Book::notes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Book.notes#updateById
             * @methodOf lbServices.Book.notes
             *
             * @description
             *
        ...
        R.notes.updateById = function() {
          var TargetResource = $injector.get("Note");
          var action = TargetResource["::updateById::Book::notes"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/notes/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Book.notes.createMany() instead.
            "::createMany::Book::notes": {
              isArray: true,
              url: urlBase + "/books/:id/notes",
              method: "POST",
            },
        ...
        */
        ...
        R.book = function() {
          ...
          var action = TargetResource["::get::Note::book"];
          return action.apply(R, arguments);
        };
